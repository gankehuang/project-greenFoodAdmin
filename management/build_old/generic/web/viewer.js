...
var DEFAULT_URL = 'http://10.123.56.198:8011/File' + getUrlParam('url');   //获取地址栏参数
...
function getViewerConfiguration() {
  return {
    ...
    findBar: {
      ...
      change_Page: document.getElementsByClassName('item'),   
      change_Page_parent: document.getElementById('change_Page')  
    },
    passwordOverlay: {
...
exports.PDFFindBar = exports.change_Page =  undefined;
...
var change_Page = function(v) {
    window.location.href = changeURLArg(window.location.href,'page',v)
}
...
var PDFFindBar = function () {
  function PDFFindBar(options) {
    ...
    this.change_Page = options.change_Page || null;   
    this.change_Page_parent = options.change_Page_parent || null;   
    ...
    　　　　//console.log(ajax.responseText);//输入相应的内容
            var xmlContent = ajax.responseText;
            //console.log(result.querySelector('title'));
      　}
    }

    /*var btn = `<li class="item">10</li><li class="item">20</li><li class="item">30</li><li class="item">40</li>`
    this.change_Page_parent.innerHTML = btn
    console.log(this.change_Page);
    var itemNum = this.change_Page;
    for(var i=0; i<itemNum.length; i++) {
        itemNum[i].onclick = function() {
            console.log(this.innerHTML);
            window.location.href = changeURLArg(window.location.href,'page',30)
        }
    }*/
    /*for(var i in this.change_Page) {
        //console.log(this.change_Page[i])
        this.change_Page[i].onclick = function () {   //点击目录按钮
            console.log(111);
            //window.location.href = changeURLArg(window.location.href,'page',20)
        };
    }*/
